...
class TestGerenciadorAgenda(TestCase):
    ...
    def test_horario_invalido(self):
        ...
        self.assertFalse(gerenciador.validar_formato_horario("10:65"))  # Minuto inválido
    ...
    def test_agendamento_fora_do_horario(self):
        ...
        self.assertEqual(str(context.exception), MensagensErro.HORARIO_INDISPONIVEL.value)
    ...
    def test_prevencao_sobreposicao_conflito_agendamento(self):
        ...
        self.assertEqual(str(context.exception), MensagensErro.CONFLITO_DE_HORARIO.value)
